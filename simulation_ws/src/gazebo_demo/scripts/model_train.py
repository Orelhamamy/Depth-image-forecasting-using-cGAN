...
OBSERVE_SIZE = 10 # How many img to observe
OUTPUT_SIZE = 1
...
generate_image(x_train[0], y_train[0], model = generator)
plt.figure()
...
@tf.function
def train_step(input_imgs, target, epoch):
...
def fit(x_train, y_train, test_ds = False, epochs = EPOCHS):
